...
[![License](https://img.shields.io/github/license/aa3979674385/my-blog?style=flat-square)](../LICENSE)
[![GitHub stars](https://img.shields.io/github/stars/aa3979674385/my-blog?style=flat-square)](https://github.com/aa3979674385/my-blog/stargazers)
...
> **About this project**
>
> This repository is a derivative work of [du2333/flare-stack-blog](https://github.com/du2333/flare-stack-blog), released under the **GPL-3.0** license.
> On top of the upstream blog engine, it adds a full content-monetization stack — membership tiers, card-key redemption, points & daily check-in, resource downloads with access control — plus a custom front-end theme and mobile layout.
> See the [Chinese README](../README.md) for the full list of customizations.
