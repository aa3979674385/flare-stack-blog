  ...
  return (
    <div className="w-full max-w-4xl mx-auto flex flex-col gap-6 pb-12">
      ...
      <div className="flex flex-col gap-4">
        {query.trim() === "" && (
          <div
            className="fuwari-card-base p-16 flex flex-col items-center justify-center text-center"
          >
        ...
        {query.trim() !== "" && !isSearching && results.length === 0 && (
          <div
            className="fuwari-card-base p-12 flex flex-col items-center justify-center text-center"
          >
