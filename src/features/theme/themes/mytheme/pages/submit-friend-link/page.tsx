...
export function SubmitFriendLinkPage({
  ...
  return (
    <div className="flex flex-col gap-4 w-full">
      {/* Header */}
      <div
        className="fuwari-card-base p-6 md:p-8 relative overflow-hidden flex flex-col items-center justify-center min-h-48 bg-linear-to-br from-(--fuwari-primary)/5 to-transparent"
      >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
        {/* Form Section */}
        <div
          className="lg:col-span-3 fuwari-card-base p-6 md:p-8"
        >
        ...
        {/* My Links Section */}
        <div
          className="lg:col-span-2 fuwari-card-base p-6 md:p-8 self-start"
        >
